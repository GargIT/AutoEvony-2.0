package com.umge.sovt.common.module.castle
{
    ...
    public class CoinsNeedResponse extends BaseBean
    {
        ...
        override public function toDebugString(param1:String = "") : String
        {
            var _loc_3:int;
            var _loc_2:String;
            _loc_2 = _loc_2 + (param1 + "coinsNeed = " + this.coinsNeed + "\n");
        ...
        public function copyTo(param1:CoinsNeedResponse) : void
        {
            param1.coinsNeed = this.coinsNeed;
        ...
        public function toObject() : Object
        {
            ...
            _loc_1.coinsNeed = this.coinsNeed;
