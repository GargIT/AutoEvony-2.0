package com.umge.sovt.common.module.alliance
{
    ...
    public class HasAllianceResponse extends BaseBean
    {
        ...
        public function toObject() : Object
        {
            ...
            _loc_1.indexAllianceInfoBean = this.indexAllianceInfoBean.toObject();
            _loc_1.msg = this.msg;
            _loc_1.ok = this.ok;
            _loc_1.packageId = this.packageId;
            _loc_1.serialVersionUID = this.serialVersionUID;
            return _loc_1;
        }// end function
        ...
        override public function toDebugString(param1:String = "") : String
        {
            ...
            if (indexAllianceInfoBean != null)
            {
                _loc_2 = _loc_2 + this.indexAllianceInfoBean.toDebugString(param1 + "indexAllianceInfoBean.");
            }
            else
            {
                _loc_2 = _loc_2 + (param1 + "indexAllianceInfoBean = null\n");
            }// end else if
            _loc_2 = _loc_2 + (param1 + "msg = " + this.msg + "\n");
            _loc_2 = _loc_2 + (param1 + "ok = " + this.ok + "\n");
            _loc_2 = _loc_2 + (param1 + "packageId = " + this.packageId + "\n");
            _loc_2 = _loc_2 + (param1 + "serialVersionUID = " + this.serialVersionUID + "\n");
            _loc_3 = 0;
        ...
        public function copyTo(param1:HasAllianceResponse) : void
        {
            param1.errorMsg = this.errorMsg;
            if (indexAllianceInfoBean != null)
            {
                this.indexAllianceInfoBean.copyTo(param1.indexAllianceInfoBean);
            }
            else
            {
                param1.indexAllianceInfoBean = null;
            }// end else if
            param1.msg = this.msg;
            param1.ok = this.ok;
            param1.packageId = this.packageId;
            param1.serialVersionUID = this.serialVersionUID;
